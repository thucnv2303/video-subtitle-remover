...
| BUG-005 | Pipeline 1 start action executed the Pipeline 2 inpainting/rendering path and generated an OCR temporary MP4 instead of completing the expected P1 text extraction flow. | Runtime baseline | NOT YET VERIFIED | OPEN | RUNTIME VERIFIED |
